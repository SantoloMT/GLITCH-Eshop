...
/**
 * Servlet implementation class RedirecVisualizzaEmail
 */
@WebServlet("/LeggiEmail")
public class LeggiEmail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//effettua la forward a VisualizzaEmail.jsp
		RequestDispatcher requestDispatcher = request.getRequestDispatcher("WEB-INF/view/VisualizzaEmail.jsp");
